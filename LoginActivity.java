...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usernameET = findViewById(R.id.lUsernameEditText);
        passwordET = findViewById(R.id.lPasswordEditText);
    ...
    private void login() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://"+ ip +"/voice_email/api/login.php", new Response.Listener<String>() {
            @Override
